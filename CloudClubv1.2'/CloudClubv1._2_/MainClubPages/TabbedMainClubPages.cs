...
namespace FrontEnd
{
    public class TabbedMainClubPages : TabbedPage
    {
        ...
        MyClubsPage mcp;
        ProfilePage pp;
        public TabbedMainClubPages(List<Club> clubList, List<Club> memberClubList, List<Club> popularClubs, List<Club> newestClubs)   
        {
            ch = new ColorHandler();
           ...
           // NavigationPage.SetTitleIcon(CurrentPage,"CloudIcon.png");
            ...
            csp = new ClubSearchPage(clubList, memberClubList, popularClubs,newestClubs);
